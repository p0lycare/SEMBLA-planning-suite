...
const SAMMELMERKMALE = EINTRAEGE[0];
...
const EINLEGEMENGE = EINTRAEGE[1];
...
// `EINTRAEGE[2]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
const ZEICHNUNGSSYNC = EINTRAEGE[2];
...
// ueber `EINTRAEGE[3]` geprueft; die bisherige Reihe ist dafuer geschlossen um eins nach
...
const EDITIERMODUS = EINTRAEGE[3];
...
// direkt ueber `EINTRAEGE[4]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
const AUSGLEICHSMENGE = EINTRAEGE[4];
...
const MASSORIENTIERUNG = EINTRAEGE[5];
...
// als einzige direkt ueber `EINTRAEGE[6]` geprueft. Aussagewahr heisst hier: geliefert ist die
...
const AUSGLEICHSPUNKTE = EINTRAEGE[6];
...
const KATALOGMODUL = EINTRAEGE[7];
...
const PDFRUECKKEHR = EINTRAEGE[8];
...
const HANDBUCHREGELN = EINTRAEGE[11];
...
// einziges direkt ueber `EINTRAEGE[12]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
// einzige direkt ueber `EINTRAEGE[13]` geprueft. Aussagewahr heisst hier: geliefert ist
...
// einziger direkt ueber `EINTRAEGE[16]` geprueft; die bisherige Reihe rueckt geschlossen um
...
// `EINTRAEGE[17]`, weil die Randregel der Spannachsen und die einheitliche Bezeichnung der
...
const EINBAUHOEHE = EINTRAEGE[17];
...
const EINBAULAGEN = EINTRAEGE[19];
...
const ZEICHNUNGSPDF = EINTRAEGE[20];
...
const VORSCHAUHOEHE = EINTRAEGE[21];
...
const STANDARDLAENGE = EINTRAEGE[22];
...
const KOPIERSCHUTZ = EINTRAEGE[23];
...
// zu drehen.
const VORHER = EINTRAEGE.slice(42);
const NEU = EINTRAEGE.slice(48);
const AKTUELL = EINTRAEGE.slice(53);
const AELTER = EINTRAEGE.slice(63);
...
const SPANNPLATTE = EINTRAEGE[25];
...
const WANDAUSWAHL = EINTRAEGE[26];
...
const VORRATSSATZ = EINTRAEGE[30];
...
const GESCHOSSMENGE = EINTRAEGE[32];
...
const TEILAUSWAHL = EINTRAEGE[33];
...
// unveraendert, es entsteht kein Feld und kein Versionssprung.
const IMPORTDIALOG = EINTRAEGE[34];
