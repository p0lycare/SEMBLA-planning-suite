...
// `EINTRAEGE[0]` geprueft; die bisherige Reihe rueckt geschlossen um eins nach hinten.
...
const DECKENZEIGEN = EINTRAEGE[0];
...
// aus #94) ist der neueste Eintrag — er wird als einziger direkt ueber `EINTRAEGE[1]` geprueft;
...
// chg-20260907-20) ist der neueste Eintrag — er wird als einziger direkt ueber `EINTRAEGE[2]`
...
const SAMMELMEHRFACH = EINTRAEGE[2];
...
const OHNE_SCHEIBE = EINTRAEGE[3];
...
// mit [A-3]/#97) sind der neueste Eintrag — er wird als einziger direkt ueber `EINTRAEGE[4]`
...
const ANSICHTMASSTAB = EINTRAEGE[4];
...
// sie werden als einzige direkt ueber `EINTRAEGE[5]` geprueft; die bisherige Reihe rueckt
...
// er wird als einziger direkt ueber `EINTRAEGE[6]` geprueft; die bisherige Reihe rueckt geschlossen
...
const SAMMELPRODUKTE = EINTRAEGE[6];
...
const SPANNSYMBOLE = EINTRAEGE[7];
...
// es wird als einziges direkt ueber `EINTRAEGE[8]` geprueft; die bisherige Reihe rueckt geschlossen
...
const SAMMELMERKMALE = EINTRAEGE[8];
...
const EINLEGEMENGE = EINTRAEGE[9];
...
// `EINTRAEGE[10]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
const ZEICHNUNGSSYNC = EINTRAEGE[10];
...
// ueber `EINTRAEGE[11]` geprueft; die bisherige Reihe ist dafuer geschlossen um eins nach
...
const EDITIERMODUS = EINTRAEGE[11];
...
// direkt ueber `EINTRAEGE[12]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
const AUSGLEICHSMENGE = EINTRAEGE[12];
...
const MASSORIENTIERUNG = EINTRAEGE[13];
...
// als einzige direkt ueber `EINTRAEGE[14]` geprueft. Aussagewahr heisst hier: geliefert ist die
...
const AUSGLEICHSPUNKTE = EINTRAEGE[14];
...
const KATALOGMODUL = EINTRAEGE[15];
...
const PDFRUECKKEHR = EINTRAEGE[16];
...
const ACHSTREFFER = EINTRAEGE[17];
...
const HANDBUCHREGELN = EINTRAEGE[19];
...
// einziges direkt ueber `EINTRAEGE[20]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
// einzige direkt ueber `EINTRAEGE[21]` geprueft. Aussagewahr heisst hier: geliefert ist
...
// einziger direkt ueber `EINTRAEGE[24]` geprueft; die bisherige Reihe rueckt geschlossen um
...
// `EINTRAEGE[25]`, weil die Randregel der Spannachsen und die einheitliche Bezeichnung der
...
const EINBAUHOEHE = EINTRAEGE[25];
...
const EINBAULAGEN = EINTRAEGE[27];
...
const ZEICHNUNGSPDF = EINTRAEGE[28];
...
const VORSCHAUHOEHE = EINTRAEGE[29];
...
const STANDARDLAENGE = EINTRAEGE[30];
...
const KOPIERSCHUTZ = EINTRAEGE[31];
...
// zu drehen.
const VORHER = EINTRAEGE.slice(50);
const NEU = EINTRAEGE.slice(56);
const AKTUELL = EINTRAEGE.slice(61);
const AELTER = EINTRAEGE.slice(71);
...
const SPANNPLATTE = EINTRAEGE[33];
...
const WANDAUSWAHL = EINTRAEGE[34];
...
const VORRATSSATZ = EINTRAEGE[38];
...
const GESCHOSSMENGE = EINTRAEGE[40];
...
const TEILAUSWAHL = EINTRAEGE[41];
...
// unveraendert, es entsteht kein Feld und kein Versionssprung.
const IMPORTDIALOG = EINTRAEGE[42];
