...
// Der NEUESTE Eintrag ist die pflegbare Einbauhoehe eines Kleinteils (#92) — er wird als
// einziger direkt ueber `EINTRAEGE[0]` geprueft; die bisherige Reihe rueckt geschlossen um
// eins nach hinten. Aussagewahr heisst hier: versprochen wird GENAU das Eingabefeld im
...
const EINBAUHOEHE = EINTRAEGE[0];
ok("[#92] die pflegbare Einbauhöhe eines Kleinteils ist der neueste Eintrag",
...
const ZEICHNUNGSPDF = EINTRAEGE[3];
...
const VORSCHAUHOEHE = EINTRAEGE[4];
...
const STANDARDLAENGE = EINTRAEGE[5];
...
const KOPIERSCHUTZ = EINTRAEGE[6];
...
// zu drehen.
const VORHER = EINTRAEGE.slice(25);
const NEU = EINTRAEGE.slice(31);
const AKTUELL = EINTRAEGE.slice(36);
const AELTER = EINTRAEGE.slice(46);
...
const VORRATSSATZ = EINTRAEGE[13];
...
const GESCHOSSMENGE = EINTRAEGE[15];
...
const TEILAUSWAHL = EINTRAEGE[16];
...
// unveraendert, es entsteht kein Feld und kein Versionssprung.
const IMPORTDIALOG = EINTRAEGE[17];
