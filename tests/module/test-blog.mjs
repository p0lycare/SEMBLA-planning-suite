...
const EINLEGEMENGE = EINTRAEGE[0];
...
// `EINTRAEGE[1]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
const ZEICHNUNGSSYNC = EINTRAEGE[1];
...
// ueber `EINTRAEGE[2]` geprueft; die bisherige Reihe ist dafuer geschlossen um eins nach
...
const EDITIERMODUS = EINTRAEGE[2];
...
// direkt ueber `EINTRAEGE[3]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
const AUSGLEICHSMENGE = EINTRAEGE[3];
...
const MASSORIENTIERUNG = EINTRAEGE[4];
...
// als einzige direkt ueber `EINTRAEGE[5]` geprueft. Aussagewahr heisst hier: geliefert ist die
...
const AUSGLEICHSPUNKTE = EINTRAEGE[5];
...
const KATALOGMODUL = EINTRAEGE[6];
...
const PDFRUECKKEHR = EINTRAEGE[7];
...
const HANDBUCHREGELN = EINTRAEGE[10];
...
// einziges direkt ueber `EINTRAEGE[11]` geprueft; die bisherige Reihe rueckt geschlossen um eins
...
// einzige direkt ueber `EINTRAEGE[12]` geprueft. Aussagewahr heisst hier: geliefert ist
...
// einziger direkt ueber `EINTRAEGE[15]` geprueft; die bisherige Reihe rueckt geschlossen um
...
// `EINTRAEGE[16]`, weil die Randregel der Spannachsen und die einheitliche Bezeichnung der
...
const EINBAUHOEHE = EINTRAEGE[16];
...
const EINBAULAGEN = EINTRAEGE[18];
...
const ZEICHNUNGSPDF = EINTRAEGE[19];
...
const VORSCHAUHOEHE = EINTRAEGE[20];
...
const STANDARDLAENGE = EINTRAEGE[21];
...
const KOPIERSCHUTZ = EINTRAEGE[22];
...
// zu drehen.
const VORHER = EINTRAEGE.slice(41);
const NEU = EINTRAEGE.slice(47);
const AKTUELL = EINTRAEGE.slice(52);
const AELTER = EINTRAEGE.slice(62);
...
const SPANNPLATTE = EINTRAEGE[24];
...
const WANDAUSWAHL = EINTRAEGE[25];
...
const VORRATSSATZ = EINTRAEGE[29];
...
const GESCHOSSMENGE = EINTRAEGE[31];
...
const TEILAUSWAHL = EINTRAEGE[32];
...
// unveraendert, es entsteht kein Feld und kein Versionssprung.
const IMPORTDIALOG = EINTRAEGE[33];
