...
// Der NEUESTE Eintrag ist der Rueckbau des Startachsen-Bedienfelds (#104) — er wird als
...
// `EINTRAEGE[3]`, weil die Randregel der Spannachsen und die einheitliche Bezeichnung der
...
const ZEICHNUNGSPDF = EINTRAEGE[6];
...
const VORSCHAUHOEHE = EINTRAEGE[7];
...
const STANDARDLAENGE = EINTRAEGE[8];
...
const KOPIERSCHUTZ = EINTRAEGE[9];
...
// zu drehen.
const VORHER = EINTRAEGE.slice(28);
const NEU = EINTRAEGE.slice(34);
const AKTUELL = EINTRAEGE.slice(39);
const AELTER = EINTRAEGE.slice(49);
...
const SPANNPLATTE = EINTRAEGE[11];
...
const WANDAUSWAHL = EINTRAEGE[12];
...
const VORRATSSATZ = EINTRAEGE[16];
...
const GESCHOSSMENGE = EINTRAEGE[18];
...
const TEILAUSWAHL = EINTRAEGE[19];
...
// unveraendert, es entsteht kein Feld und kein Versionssprung.
const IMPORTDIALOG = EINTRAEGE[20];
